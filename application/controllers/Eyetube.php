...
class Eyetube extends CI_Controller {
	...
	public function detail($url)
	{
		...
		<meta name= "twitter:image" content= "'.imgUrl().'systems/eyetube_storage/'.$data['eyetube_headline']->thumb.'" />
		...
		<meta property= "og:image" content= "'.imgUrl().'systems/eyetube_storage/'.$data['eyetube_headline']->thumb.'" />
