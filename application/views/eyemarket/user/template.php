      ...
      <div class=" container-scroller">
        ...
        <nav class="navbar bg-primary-gradient col-lg-12 col-12 p-0 fixed-top navbar-inverse d-flex flex-row">
            <div class="bg-white text-center navbar-brand-wrapper">
                <a class="navbar-brand brand-logo" href="#"><img src="<?=base_url()?>assets/eyemarket/eyemarket_icon.png" style="width: 40px;" /></a>
                <a class="navbar-brand brand-logo-mini" href="#"><img src="<?=base_url()?>assets/eyemarket/eyemarket_icon.png"  alt=""></a>
            </div>
