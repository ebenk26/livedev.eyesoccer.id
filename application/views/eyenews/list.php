...
<div class="col-xs-12 col-sm-12">
<div class="row">
<div class="col-xs-6 col-sm-6"><div class="row" style="padding:2px;" id="t101"><a href="<?=base_url()?>eyenews/search/Usia Muda" class="btn btn-warning btn-block" style="background:#FFE01E;color:#3d3d3d;border:solid #FFE01E 1px;">Usia Muda</a></div></div>
...
<div class="col-xs-12 col-sm-12">
<div class="row">
<div class="col-xs-12 col-sm-12"><div class="row" style="padding:2px;" id="t101"><a href="<?=base_url()?>eyenews/search/Soccer Series" class="btn btn-warning btn-block" style="background:#FFE01E;color:#3d3d3d;border:solid #FFE01E 1px;">Soccer Series</a></div></div>
</div>
</div>  
...
<h1 id="t101"><img src="http://eyesoccer.id/img/icon_eyenews.png" class="img img-responsive" style="width:30px;height:30px;display:inline;"> EyeNews</h1>  
<!--update rizki start-->
<?php
...
$x++;
if($x==1)
$construct .="news_type LIKE '%$search_each%' OR title LIKE '%$search_each%'";
else
$construct .="AND news_type LIKE '%$search_each%' OR title LIKE '%$search_each%'";
    
} */
$construct .="news_type LIKE '%$search%' OR title LIKE '%$search%'";
...
<div class="thumbnail drop-shadow2">
    ...
    <a href="'.base_url().'eyenews/detail/'.$runrows['eyenews_id'].'">
      <img src="'.base_url().'systems/eyenews_storage/'.$runrows['pic'].'" class="img-polaroid thumbnail2" alt="Lights" style="width:100% !important;margin: 0 auto;">
...
{   
if (!($start<=0)) 
echo "<li><a href='".base_url()."eyenews/search/$search/$prev' class='btn btn-sm btn-info'>Prev</a></li>";    
...
echo "<li><a href='".base_url()."eyenews/search/$search/$next' class='btn btn-sm btn-info'>Next</a></li>";    
}   
echo "</ul></div>";
} 
} 
...
<div class="col-lg-12 col-md-12">
<div class="row">
<div class="col-lg-6 col-md-6"><div class="row" style="padding:2px;" id="t101"><a href="<?=base_url()?>eyenews/search/Usia Muda" class="btn btn-warning btn-block" style="background:#FFE01E;color:#3d3d3d;border:solid #FFE01E 1px;">Usia Muda</a></div></div>
...
<div class="col-lg-12 col-md-12">
<div class="row">
<div class="col-lg-12 col-md-12"><div class="row" style="padding:2px;" id="t101"><a href="<?=base_url()?>eyenews/search/Soccer Series" class="btn btn-warning btn-block" style="background:#FFE01E;color:#3d3d3d;border:solid #FFE01E 1px;">Soccer Series</a></div></div>
</div>
</div>  
