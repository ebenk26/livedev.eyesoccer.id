		...
		<div class="carous center-desktop" style="margin-top: -30px;">
            <img class="img-title lazy" data-original="<?php echo base_url()?>assets/home/img/ic_eyeprofile.png" alt="">
						...
						?>			
								...
								<a href="<?=base_url().'eyeprofile/klub_detail/'.$club['link_klub']; ?>">
									<div class="box-content">
										<!--<img class="lazy" data-original="assets/img/ss-img.png" alt="">-->
										<!--<img height="100px;" data-original="assets/img/ss-img.png">-->
										<img class="lazy" data-original="<?=imgUrl()?>systems/club_logo/<?php print $club['logo']; ?>">
										<div class="detail">
                ...
                <div class="bx-pemain carousel-inner" role="listbox">
					...
					?>		
						<a href="<?=base_url().'eyeprofile/pemain_detail/'.$player['link_player']; ?>">
							<div class="ctn-pemain">
								<!--<img class="lazy" data-original="assets/img/ss-img.png" alt="">-->
							  <div class="des-img">
								<img class="lazy" data-original="<?php echo imgUrl();?>systems/player_storage/<?= $player['foto']; ?>" alt=""></div>
					...
					?>		
						<a href="<?=base_url().'eyeprofile/pemain_detail/'.$player['link_player']; ?>">
							<div class="ctn-pemain">
								<!--<img class="lazy" data-original="assets/img/ss-img.png" alt="">-->
								<div class="des-img"><img class="lazy" data-original="<?php echo imgUrl();?>systems/player_storage/<?= $player['foto']; ?>" alt=""></div>
								<div class="container des">
									<?php
										$str_name = strlen($player['nama']);
										if($str_name > 20){
        ...
        <div class="center-desktop">        
            <img class="img-title lazy" data-original="<?php echo base_url()?>assets/home/img/ic_eyetube.png" alt="">
				...
				?>
					<a href="<?=base_url().'eyetube/detail/'.$videonya['url']; ?>">
						<div class="et-v-content">
							<img class="lazy" data-original="<?=imgUrl()?>systems/eyetube_storage/<?= $videonya['thumb']; ?>" alt="">
							<!--<img class="lazy" data-original="<?=base_url()?>systems/eyetube_storage/<?= $videonya['thumb']; ?>" alt="">-->
							<div class="btn-play">
								<img class="lazy" data-original="<?php echo base_url()?>assets/home/img/btn-play.png" alt="">
							</div>
						</div>
					</a>
                    <span class="et-st">
					...
					<div role="listbox" class="carousel-inner">                    
							...
							<a href="<?=base_url().'eyetube/detail/'.$stars['url']; ?>" style="text-decoration: unset;">
								<div class="vid-box-vl">
									<div class="vid-box-vl-img">
										<img class="lazy" data-original="<?=imgUrl()?>systems/eyetube_storage/<?= $stars['thumb'];?>" alt="">										
									</div>
                        ...
                        <div id="vpopuler" class="box item">
							...
							<a href="<?=base_url().'eyetube/detail/'.$populer['url']; ?>" style="text-decoration: unset;">
								<div class="vid-box-vl">
									<!--<img class="lazy" data-original="assets/img/video-small.png" alt="">-->
									<div class="vid-box-vl-img">
										<img class="lazy" data-original="<?=imgUrl()?>systems/eyetube_storage/<?= $populer['thumb'];?>" alt="">										
									</div>
                        ...
                        <div id="vkamu" class="box item">
							...
							<a href="<?=base_url().'eyetube/detail/'.$kamu['url']; ?>" style="text-decoration: unset;">
								<div class="vid-box-vl">
									<div class="vid-box-vl-img">
										<img class="lazy" data-original="<?=imgUrl()?>systems/eyetube_storage/<?= $kamu['thumb'];?>" alt="">
									</div>
        ...
        <div class="center-desktop">
            <div class="et-content m-b-150">
                <div class="et-content1">
                    <img class="img-title lazy" data-original="<?php echo base_url(); ?>assets/img/ic_eyenews.png" alt="">
                    ...
                    <div class="h-berita-terkait" style="margin:40px 0;height:135px;overflow:hidden;">
                        ...
                        <ul>
                            <li>
								...
								<img class="lazy" data-original="<?php echo base_url(); ?>assets/img/chevron-right-red.png"> <?= $similar['title']; ?></a>
                            </li>
                        </ul>
						<?php			
						}
                ...
                <div class="et-content2">
                    <img class="img-title lazy" data-original="<?php echo base_url()?>assets/home/img/ic-eyeme.png" alt="">
                    	...
                    	<?php 
                    		for($i=0;$i < 9 ; $i++){
                    			echo '<div class="eyeme-list">';
	                    			...
	                    			echo '<img class="lazy" data-original="'.(isset($imgEyeme[$i]) ? MEIMG.$imgEyeme[$i]->img_name :  DEFAULTIMG ).'" class="c-em-content2-img">';
	                    			echo '</a>';
                    			echo '</div>';
                    		}
                    	?>
        ...
        <div class="center-desktop">
            <div class="et-content">
                        ...
                        <div id="tab2" class="carousel slide">
                            <div role="listbox" class="carousel-inner">                    
								...
								?>
                                    <div class="rek-ber">
										<div class="rek-ber-c">
											<!--<img class="lazy" data-original="assets/img/video-small.png" style="width:150px" alt="">-->
											<div style="width: 160px;height: 100px;overflow:  hidden;display:  inline-block;"><img class="lazy" data-original="<?php echo imgUrl(); ?>systems/eyenews_storage/<?= $populer['thumb1']; ?>" style="width:100%; min-height:100%;" alt=""></div>
								...
								?>
                                    <div class="rek-ber">
										<div class="rek-ber-c">
										<div style="width: 160px;height: 100px;overflow:  hidden;display:  inline-block;"><img class="lazy" data-original="<?php echo imgUrl(); ?>systems/eyenews_storage/<?= $rekomendasi['thumb1']; ?>"style="width:100%; min-height:100%;" alt=""></div>
										<div class="container" style="width: 70%;float:  right;">	
								...
								?>
                                    <div class="rek-ber">
										<div class="rek-ber-c">
										<div style="width: 160px;height: 100px;overflow:  hidden;display:  inline-block;"><img class="lazy" data-original="<?php echo imgUrl(); ?>systems/eyenews_storage/<?= $muda['thumb1']; ?>" style="width:100%; min-height:100%;" alt=""></div>
											<div class="container" style="width: 70%;float:  right;">	
                ...
                <div class="et-content2">
                    <img class="img-title lazy" data-original="<?php echo base_url()?>assets/home/img/ic_eyemarket.png" alt="">
                        ...
                        <div class="rek-ber" style="margin-top: -14px;">			
							...
							<div class="rek-ber-c">
								<div style="width: 100px;height:  100px;overflow:  hidden;display:  inline-block;">
									<img class="lazy" data-original="<?= base_url(); ?>img/eyemarket/produk/<?= $produk['image1'] ?>" alt="" style="width:100%; min-height:100%;">
								</div>
        ...
        <div class="center-desktop">
            <div class="banner-150" style="margin-top: 20px;">
                <img class="lazy" data-original="<?php echo base_url()?>assets/img/banner-home.jpeg" alt="">
            </div>
        </div>
        <!-- EYEVENT -->
        <div class="center-desktop">
            <img class="img-title lazy" data-original="<?php echo base_url()?>assets/home/img/ic_eyevent.png" alt="">
                    ...
                    <div role="listbox" class="carousel-inner" style="width: max-content;height: 225px;">  				
						...
						?>
                            <div class="ev-box-content">
                                <!--<img class="lazy" data-original="assets/img/video-small.png" alt="">-->
								<img class="lazy" data-original="<?=imgUrl()?>systems/eyevent_storage/<?php print $row['thumb1']; ?>">								
                            </div>
						<?php }?>
                        </div>
                        <div class="box item">	
							...
							?>
								<tbody>
									<tr>
										...
										<td><span class="i-l"><img class="lazy" data-original="<?=imgUrl()?>systems/club_logo/<?php print $row['logo_a']; ?>" alt=""></span></td>
										...
										<td><span class="i-r"><img class="lazy" data-original="<?=imgUrl()?>systems/club_logo/<?php print $row['logo_b']; ?>" alt=""></span></td>
