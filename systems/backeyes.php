...
<div class="container"><br>
    ...
    <div class="col-lg-4" id="back7"><br>
        <center><img src="../img/logo_login.png" class="img img-responsive" id="img7">
            <h5 class="text-center" id="t5">Eyesoccer</h5></center>
        <br>
        <form method="post">
            ...
            <div class="form-group" id="set=8"><input type="submit" name="opt1" value="LOGIN" class="btn btn-block" id="btn2"></div>
            <br><br>
            <?php
            if (isset($_POST['opt1'])) {
                ...
                if ($row['username'] == "" && $row['password'] == "") {
                    ...
                    header("location:" . $base_url . "/systems/index?admin_id=$admin_id");
                }
            }
            ?>
        </form>
