...
//}
                                ...
                                <div class="form-group text-left" id="t1">Provinsi
                                    <select name="IDProvinsi" class="form-control provinsi_liga" id="ipt1">
                                ...
                                <div class="form-group text-left" id="t1">Deskripsi<textarea name="description" class="form-control" maxlength="500" rows="5" id="set8"></textarea>
                                </div>
                                ...
                                <div id="liga_amatir">
                                    <div class="form-group text-left" id="t1">Jadwal Latihan<input type="text" name="training_schedule" class="form-control" id="ipt1"
                                                                                                   placeholder="contoh: Jumat 13:00-14:30 WIB"></div>
                                    <div class="form-group text-left" id="t1">Nama Alumnus<input type="text" name="alumnus_name" class="form-control" id="ipt1"
                                                                                                 placeholder="contoh: Joko, Arman, Anton"></div>
                                </div>
                                <div class="form-group text-left" id="t1">
                                    Prestasi Klub
                                    <input autocomplete="off" class="input form-control" id="field1" name="field[]" style="width: 94%;" type="text"
                                           placeholder="bulan#tahun#turnamen#peringkat#pelatih" data-items="8">
...
<td>';
                        if ($data['active'] == 1) {
                            print '<a href="status?club_id=' . $club_id . '" class="btn btn-success btn-sm">Active</a>';
                        } else {
                            print '<a href="status?club_id=' . $club_id . '" class="btn btn-danger btn-sm">Deactive</a>';
                        }
                        print '</a></td>
<td>
...
<script>
    $(function () {
        $("body").on("change", ".provinsi_liga", function () {
            liga_id = $(this).val();
            $.ajax({
                type: "POST", data: {'liga_id': liga_id}, url: "<?=$base_url?>/getKabupaten2.php", dataType: "json", success: function (data) {
                    $(".kabupaten_liga").fadeOut("fast", function () {
                        $(".kabupaten_liga").empty().html(data.html1);
                        $(".kabupaten_liga").fadeIn("fast");
                    });
                }
            });
        })
