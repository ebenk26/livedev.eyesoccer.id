                        ...
                        <div class="modal-body">
                            <form method="post" enctype="multipart/form-data">
                                ...
                                if (isset($_POST['opt1a'])) {
                                    ...
                                    $cmd = mysqli_query($con, "insert into tbl_eyetube (title,admin_id,category_name,description,thumb,thumb1,video,duration,createon,url) values ('" . $title . "','" . $_GET['admin_id'] . "','" . $category_name . "','" . $description . "','" . $thumb . "','','" . $video . "','" . $duration . "','" . $now . "','" . $url . "')");
                                ...
                                <div class="form-group text-left" id="t1">Duration<input type="text" name="duration" class="form-control" id="ipt1" required></div>
                                <div class="form-group" id="t1"><input type="submit" name="opt1a" value="ADD" class="btn btn-block" id="btn1"></div>
                                <br><br>
                            </form>
                        </div>
                    </div>
            ...
            <div class="table table-responsive">
                <table class="table table-hover datatables">
                    ...
                    while ($data = mysqli_fetch_array($result)) {
                        ...
                        $title = $data['title'];
                        $video = $data['video'];
                        $thumb = ($_SERVER['SERVER_NAME'] == 'localhost') ? $data['thumb'] : $data['thumb'].'/small';
                        print'<tr>
<td><img src="' . TUBESTATIC . $thumb . '" id="img4"></td>
<td>' . $title . '</td>
<td>' . $category_name . '</td>
<td>' . $data["fullname"] . '</td>
