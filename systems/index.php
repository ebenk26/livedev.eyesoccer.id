    ...
    <div class="row">
            ...
            if (!isset($_SESSION["access"]) || $_SESSION["access"] != "management") {
                ...
                <div class="col-lg-4 col-xs-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Last Viewed
                            <small class="pull-right"><?= date("d-M-Y") ?></small>
                        </div>
                        <div class="panel-body">
                            <p>
                                <n class="pull-left">Today</n>
      ...
      ?></span></p>
                ...
                <div class="col-lg-8 col-xs-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Last Page Access
                            <small class="pull-right"><?= date("d-M-Y") ?></small>
                        </div>
                        <div class="panel-body">
                            <?php
