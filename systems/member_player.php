...
$result=mysqli_query($con,"SELECT d.email as email_member,a.id_member_player,a.id_player,b.club_id,b.url,d.id_member,a.file_ktp,a.file_akte,a.file_kk,a.file_passport,a.file_ijazah,a.file_bukurek,a.file_srtrekssb,a.file_ibukandung,b.name as player_name,c.name as club_name,d.name as member_name,a.add_date,a.active FROM tbl_member_player a left join tbl_player b on b.player_id=a.id_player left join tbl_club c on c.club_id=b.club_id left join tbl_member d on d.id_member=a.id_member");
...
print'<tr>
<td>'.$member_name.'</td>
<td><a target="_blank" href="../eyeprofile/pemain_detail/'.$url.'">'.$player_name.'</a></td>
<td>'.$file_ktp.'</td>
<td>'.$file_akte.'</td>
<td>'.$file_kk.'</td>
<td>'.$file_passport.'</td>
