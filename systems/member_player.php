                ...
                <table class="table table-hover table-striped table-bordered datatables">
                    ...
                    while ($data = mysqli_fetch_array($result)) {
                        ...
                        if (!empty($data['file_ktp'])) {
                            $file_ktp = '<img class="img-player-click" src="' . MEIMG . $data['file_ktp'] . '" id="img4" style="cursor:pointer;">';
                        } else {
                            $file_ktp = "";
                        }
                        if (!empty($data['file_akte'])) {
                            $file_akte = '<img class="img-player-click" src="' . MEIMG . $data['file_akte'] . '" id="img4" style="cursor:pointer;">';
                        } else {
                            $file_akte = "";
                        }
                        if (!empty($data['file_kk'])) {
                            $file_kk = '<img class="img-player-click" src="' . MEIMG . $data['file_kk'] . '" id="img4" style="cursor:pointer;">';
                        } else {
                            $file_kk = "";
                        }
                        if (!empty($data['file_passport'])) {
                            $file_passport = '<img class="img-player-click" src="' . MEIMG . $data['file_passport'] . '" id="img4" style="cursor:pointer;">';
                        } else {
                            $file_passport = "";
                        }
                        if (!empty($data['file_ijazah'])) {
                            $file_ijazah = '<img class="img-player-click" src="' . MEIMG . $data['file_ijazah'] . '" id="img4" style="cursor:pointer;">';
                        } else {
                            $file_ijazah = "";
                        }
                        if (!empty($data['file_bukurek'])) {
                            $file_bukurek = '<img class="img-player-click" src="' . MEIMG . $data['file_bukurek'] . '" id="img4" style="cursor:pointer;">';
                        } else {
                            $file_bukurek = "";
                        }
                        if (!empty($data['file_srtrekssb'])) {
                            $file_srtrekssb = '<img class="img-player-click" src="' . MEIMG . $data['file_srtrekssb'] . '" id="img4">';
                        } else {
                            $file_srtrekssb = "";
                        }
                        if ($active == 1) {
